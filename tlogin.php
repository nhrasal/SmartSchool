...
<div  id="cont"><center>
<div class="login">
<h3><b><p style="color:black; font-family:Algerian; font-size:25px;">Welcome to Teacher Login System</p></b></h3>
...
?>
<form id="photo" name="login" method="post" action="user/teachercheck.php" onSubmit="return validateForm(); " >

<h2><div id="email">User name :</div>
<input id="uname" name="uname" type="text" placeholder="Enter Your User Name.."  /><br />
