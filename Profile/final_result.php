...
<?php include("header/header.php");   ?>
 ...
 <br>
  ...
  <table width="70%">
          <tr><td colspan="6"> <h3>View <?php echo $name; ?>  Final Term Exan Result </h2></td>
    <tr>
...
<td>
<?php 
include("grade/final_grade.php");
?> </td>
<td>
<?php 
include("grade/final_gpa.php");
?> </td>
    </tr>
...
include("total/totalfinalmark.php");
