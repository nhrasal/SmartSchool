...
$tbl_notice = "CREATE TABLE IF NOT EXISTS notice(
							...
							notice_des VARCHAR(500) NOT NULL,
							img_name VARCHAR(50) NOT NULL,
							img_path VARCHAR(50) NOT NULL,
							img_type VARCHAR(50) NOT NULL
...
$query = mysqli_query($myconn, $tbl_notice);

if ($query === TRUE) {
	echo "<h3>NOTICE  INFORMATI table created OK :) </h3>";
} else {
	echo "<h3>Notice INFORMAT table NOT created :( </h3>";
}
