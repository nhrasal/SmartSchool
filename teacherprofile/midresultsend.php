...
<br>
             ...
             <tr><td colspan="6"> <h3>Send Student Midterm Result Information Status</h3> </td>
...
$sql = "SELECT * FROM admissionform INNER JOIN midresult ON admissionform.std_id= midresult.std_id AND tchr_id='$tid' AND date='$date' ";
...
<form id="" name="" method="POST" action="midresult_send.php?tchr_id=<?php echo $tid; ?>" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <td><?php echo $cors; ?><input type="hidden" name="course[]" value="<?php echo $cors; ?>"></td>
     ...
     <td><input type="hidden" name="result[]" value="<?php echo $midexam;  ?>"><?php echo $midexam; ?></td>
     <td> <?php include("grade/grade.php"); ?> <input type="hidden" name="grade[]" value="<?php include("grade/grade.php"); ?>"></td></td>
     </tr>   
