...
<?php include("header/header.php");   ?>
 ...
 <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
       ...
       <h3><u>Final Result Input</u> </h3>
       
       <br>
    
<form id="" name="" method="POST" action="finalresultvalue.php?tchr_id=<?php echo $tid; ?>" enctype="multipart/form-data">
...
<tr><td width="200px">Student Id</td><td width="200px">Student name</td><td width="200px">Class</td><td width="200px">Course</td><td width="200px">Final Exam</td></tr>
<?php
...
$email=$row['email'];
	...
	?>
      ...
      <form id="" name="" method="POST" action="finalresultinsert.php?tchr_id=<?php echo $tid; ?>" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to Publish Final Term Exam Result?');">
     ...
     <td >
       <input type="number" name="finalexam[]" min="0" max="100" >
       </td>
     </tr>     
