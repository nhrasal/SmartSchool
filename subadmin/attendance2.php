...
<tr>
 ...
 <div align="center"><h3> <label for="date">Select Date or Month and Course</label><br />
...
$sql="SELECT * FROM stdattendance WHERE  course_id='$cors' AND date='".$_POST["date"]."' AND cls_id='$cls' ";
...
$tchr=$row['tchr_id'];
 ...
 <tr>
	 <th height="50px"><?php echo $date; ?><input type="hidden" name="std_id[]" value="<?php echo $sid; ?>"></th>
