...
<h2><center>
<form id="photo" name="photo" method="post" action="messageinsert.php?tchr_id=<?php echo $tid; ?>" enctype="multipart/form-data" onSubmit="return confirm('Are you sure?');" >


<div>

    <input type="hidden" id="message" value="<?php echo $tid; ?>"  name="tchr_id" type="text"  ></div>
