...
$sql = "SELECT * FROM midresult WHERE rslt_id='$rslt'  ";
...
$tchr=$row['tchr_id'];
	?>
<form id="" name="" method="POST" action="midmark_update_update.php" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to Update?');">
     ...
     <td><?php echo $clsid; ?></td>
      ...
      <td><?php echo $midexam; ?></td>
       <td><input type="number" name="midexam" min="0" max="100"  required /></td>
