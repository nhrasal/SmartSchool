...
<div style="color:#999"><h3><b>Total Student :<?php include("total/total_student_forclass.php");?></b></h3></div>
...
$sql = "SELECT * FROM admissionform WHERE  ( action='deactive' OR action='active' ) AND cls_id='".$_POST["cls_id"]."'  ";
...
<a href="delete/sdeletenow.php?std_id=<?php echo $pisidd; ?>" onclick="return confirm('Are you sure you want to Delete?');" ><p style="color:red;">Delete</p></a></th>
