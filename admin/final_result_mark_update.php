...
<form id="" name="" method="POST" action="finalupdate.php?cls_id=<?php echo $cls; ?>" onclick="return confirm('Are you sure you want to Delete?');" ><p style="color:red;"">
...
$sql = "SELECT * FROM finalresult WHERE cls_id='".$_POST["cls_id"]."'  ";
...
$tchr=$row['tchr_id'];
	?>
<form id="" name="" method="POST" action="final_result_mark_update_update.php" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to Update?');">
     ...
     <td><?php echo $clsid; ?></td>
      ...
      <td><input type="number" name="finalexam[]" min="0" max="100" value="<?php echo $finalexam; ?>"  required /></td>
