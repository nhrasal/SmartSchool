...
?>
 ...
 <div align="center"><h3> <label for="date">Select Month and Course</label><br />
...
$month=$_POST['date'];
$a= date("Y");
$sql = "SELECT * FROM stdattendance WHERE cls_id='".$_GET["cls_id"]."' AND MONTH(date) ='$month' AND YEAR(date) = '$a' AND course_id='$cors' ";
